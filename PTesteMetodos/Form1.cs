...
namespace PTesteMetodos
{
    public partial class frmPrincipal : Form
    {
        ...
        private void exercício2ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            objFrm2.MdiParent = this; // this é o objeto que está ativo no momento
                                      // no caso é o frmPrincipal
            objFrm2.WindowState = FormWindowState.Maximized;
            objFrm2.Show();
        }

        private void eercício3ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmExercicio3 objFrm3 = new frmExercicio3();
            objFrm3.MdiParent = this; // this é o objeto que está ativo no momento
                                      // no caso é o frmPrincipal
        ...
        private void exercício4ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            objFrm4.MdiParent = this; // this é o objeto que está ativo no momento
                                      // no caso é o frmPrincipal
        ...
        private void exercicio5ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            objFrm5.MdiParent = this; // this é o objeto que está ativo no momento
                                      // no caso é o frmPrincipal
